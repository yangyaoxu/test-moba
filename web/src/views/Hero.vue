<template>
  <div class="page-hero" v-if="model">
      <div class="topbar d-flex text-white bg-black ai-center py-2 px-3">
       ...
       <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
          ...
          <div class="d-flex jc-between pt-2" >
            <div class="scores d-flex ai-center" v-if="model.scores">
               ...
               <span>生存</span>
               <span class="badge bg-dark">{{model.scores.attack}}</span>
            </div>
...
.<style lang="scss" scoped>
  ...
  .page-hero {
    ...
    .info {
      background: linear-gradient(rgba(0,0,0,0), raba(0,0,0,1));
      .scores {
        .badge{
        margin: 0 0.25rem;
        ...
        border-radius: 50%;
        font-size: 0.6rem;
        border: 1px solid rage(255, 255, 255, 0.2);
        }
      }
    }
    .skills {
